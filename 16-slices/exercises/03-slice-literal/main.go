...
func main() {
	...
	names = []string{"A", "B", "C"}
	distances = []int{3, 10, 8, 4, 0}
	data = []byte{8, 2, 7, 0, 5}
	ratios = []float64{1.01, 141.76}
	alives = []bool{true, true, true, false}
	var s string
	...
	fmt.Printf("The length of the distances and data slices are %sthe same.\n", s)
}
